                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                              ...
                              <textarea class="form-control" placeholder="Product description" name="prod_desc" id="" cols="30" rows="3" ></textarea>
                          </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                  ...
                  <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                              <span class="text-dark"><b>Product description</b></span>
                              <textarea class="form-control" placeholder="Product description" name="prod_desc" id="" cols="30" rows="3" ><?php echo $row['prod_desc']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
